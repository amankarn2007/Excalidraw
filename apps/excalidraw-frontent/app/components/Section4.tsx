...
export default function Section4() {
    return (
        <div className="py-20 bg-blue-500 flex flex-col items-center">
            <h1 className="text-5xl font-bold text-white">Ready to start creating?</h1>
            <div className="w-190 text-center">
